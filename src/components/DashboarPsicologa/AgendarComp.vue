<template>
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-0 mb-0 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0" id="agenda">
      <!-- Aquí puedes agregar botones u otros elementos de la barra de herramientas -->
    </div>
  </div>
  ...
  <div class="mt-4">
    ...
    <div class="date-picker">
      ...
      <input type="date" id="calendario" name="calendario" v-model="tiempo_cita.fecha" @change="updateEndDate">

      <label for="hora-cita">Hora de cita:</label>
      <input type="time" id="hora-cita" v-model="tiempo_cita.hora_id">

      <hr>
    </div>
    <button class="btn btn-primary" @click="postComentarios">Guardar</button>
  </div>
</template>
