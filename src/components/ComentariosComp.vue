        ...
        <div class="contenedor card shadow-0 border mb-5 pb-5 mt-2" style="background-color: #f0f2f5;">
          <div class="card-body p-4">
            <div class="form-outline mb-4 d-flex">
              <input type="text" id="addANote" class="form-control" placeholder="Escribe un comentario..." v-model="newcomen.comentario" />
              <input type="button" value="Comentario" class="btn btn-outline-primary  btn-xs  mx-1 " @click="postcomentarios()">            </div>
            <div class="card mb-4" v-for="comentario in comentarios" :key="comentario.id_Comentarios">
              <div class="card-body">
